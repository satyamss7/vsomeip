...
public:
    ...
    bool init() {
        ...
        std::cout << "Client settings [protocol="
                ...
                << "]"
                << std::endl;
//The register state handler is used to request/find the services id
        ...
        app_->register_message_handler(
                ...
                std::bind(&client_sample::on_message, this,
                        std::placeholders::_1));
         //This is used to check the availability of the required service ID, instance id & on availabile it will bind)
       ...
       app_->register_availability_handler(SAMPLE_SERVICE_ID, SAMPLE_INSTANCE_ID,
        ...
        app_->request_event(
           ...
           sprintf(tmpbuf,"santhosh: SERVICE_ID:0x%X\tINSTANCE_ID:0x%X\tEVENTGROUP_ID:0x%X\n",SAMPLE_SERVICE_ID,SAMPLE_INSTANCE_ID,SAMPLE_EVENTGROUP_ID);  
           std::cout<<tmpbuf;
           //commented by santhosh
         app_->subscribe(SAMPLE_SERVICE_ID, SAMPLE_INSTANCE_ID, SAMPLE_EVENTGROUP_ID);//vsomeip_v3::DEFAULT_MAJOR,vsomeip_v3::ANY_EVENT);*/
         //app_->subscribe(0x1236, SAMPLE_INSTANCE_ID, SAMPLE_EVENTGROUP_ID);//vsomeip_v3::DEFAULT_MAJOR,vsomeip_v3::ANY_EVENT);
                return true;
    }
